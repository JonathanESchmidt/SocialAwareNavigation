...
'''
    BRIEF this has been coppied from the mir_robot repo to safe the necessary modifications in our repo
    This file will never be used to start the mir_bridge
    Everythin has been commented out commenting everything reveals which topics are considered and which not
'''
...
'''
    This description is a little cryptic
    These are the topics the MiR is allowed to publish
'''
...
'''
    This description is a little cryptic:
    These are the topics we publish to the MiR
'''
